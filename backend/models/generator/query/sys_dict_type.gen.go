...
func newSysDictType(db *gorm.DB, opts ...gen.DOOption) sysDictType {
	...
	_sysDictType.CreatedAt = field.NewField(tableName, "created_at")
	_sysDictType.CreatedBy = field.NewInt64(tableName, "created_by")
	_sysDictType.UpdatedAt = field.NewField(tableName, "updated_at")
	_sysDictType.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_sysDictType.IsDeleted = field.NewUint(tableName, "is_deleted")
	_sysDictType.DeletedAt = field.NewField(tableName, "deleted_at")
	_sysDictType.DeletedBy = field.NewInt64(tableName, "deleted_by")
