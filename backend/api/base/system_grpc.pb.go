...
func (UnimplementedSystemServer) AllMenu(context.Context, *emptypb.Empty) (*AllMenuReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AllMenu not implemented")
}
func (UnimplementedSystemServer) AddSysMenu(context.Context, *AddSysMenuRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddSysMenu not implemented")
}
func (UnimplementedSystemServer) UpdateSysMenu(context.Context, *AddSysMenuRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateSysMenu not implemented")
}
func (UnimplementedSystemServer) DeleteSysMenu(context.Context, *DeleteSysMenuRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteSysMenu not implemented")
}
func (UnimplementedSystemServer) GetSysMenu(context.Context, *GetSysMenuRequest) (*MenuItem, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSysMenu not implemented")
}
...
func (UnimplementedSystemServer) DictDataList(context.Context, *DictDataListRequest) (*DictDataListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method DictDataList not implemented")
}
func (UnimplementedSystemServer) DictTypeById(context.Context, *DictRequest) (*DictType, error) {
	return nil, status.Error(codes.Unimplemented, "method DictTypeById not implemented")
}
func (UnimplementedSystemServer) AddDictType(context.Context, *DictType) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddDictType not implemented")
}
...
func (UnimplementedSystemServer) AddDictData(context.Context, *DictData) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddDictData not implemented")
}
...
func (UnimplementedSystemServer) DictDataById(context.Context, *DictRequest) (*DictData, error) {
	return nil, status.Error(codes.Unimplemented, "method DictDataById not implemented")
}
func (UnimplementedSystemServer) DictDataListByType(context.Context, *DictDataListByTypeRequest) (*DictDataListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method DictDataListByType not implemented")
}
